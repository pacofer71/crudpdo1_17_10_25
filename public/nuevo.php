...
<body class="p-8 bg-blue-200">
    <h3 class="text-center text-xl font-bold mb-2">NUEVO USUARIO</h3>
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <label class="flex items-center space-x-1">
                        <input type="radio" name="admin" value="SI" class="text-blue-600 focus:ring-blue-500">
                        <span>SI</span>
                    </label>
                    <label class="flex items-center space-x-1">
                        <input type="radio" name="admin" value="NO" class="text-blue-600 focus:ring-blue-500">
                        <span>NO</span>
                    </label>
                </div>
            </div>
